  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 mt-1">
        Si la evaluación es parte de un plan específico, asociála acá.
        Cuando le asignes ese plan a un alumno, vamos a sugerirte asignar también esta evaluación.
      </p>
    </div>
  )
}
    ...
    <div className="card space-y-2">
      ...
      {evals.length === 0 ? (
        <p className="text-xs text-gray-400">
          Este plan todavía no tiene evaluaciones asociadas. Para asociar una,
          editá la evaluación y elegí este plan en “Plan asociado”.
        </p>
      ) : (
