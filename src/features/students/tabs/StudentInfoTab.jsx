...
export default function StudentInfoTab({
  ...
  async function sendForm() {
    ...
    try {
      ...
      const { error } = await supabase.from('intake_form_assignments').insert({
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditData((p) => ({ ...p, birth_date: e.target.value }))}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditData((p) => ({ ...p, height_cm: e.target.value }))}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEditData((p) => ({ ...p, target_weight_kg: e.target.value }))}
              />
            </div>
            <div>
              ...
              <input
                className="input text-sm"
                value={editData.dni || ''}
                onChange={(e) => setEditData((p) => ({ ...p, dni: e.target.value }))}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                max="7"
                className="input text-sm"
                value={editData.weekly_frequency || ''}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {PATOLOGIAS_OPTIONS.map((opt) => {
                  const selected =
                    Array.isArray(editData.patologias) && editData.patologias.includes(opt)
                  return (
                    <label
                      key={opt}
